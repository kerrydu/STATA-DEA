*! version 1.0.1  
capture program drop MTCP2015
program define MTCP2015, rclass
    version 12.1
...
// -----------------------------------------------------------------------------
	...
	qui TCP2015 `invars' = `gopvars' : `bopvars', dmu(`dmu') time(`time')
	...
	*! version 1.0.1  
capture program drop TCP2015
program define TCP2015, rclass
    version 12.1
