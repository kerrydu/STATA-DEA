*! version 1.0.1  9Jan2015
*Êä³ö¸÷¸öbeta
capture program drop UEIg2
program define UEIg2, rclass
    version 12.1
	...
	forvalues i=1/`nob' {
	  ...
	  * mat list Xmat
		 ...
		 * mat temp4=fobj[1,2..6]
		  mat betaK[`i',1]=fobj[1,2]
		  mat betaL[`i',1]=fobj[1,3]
		  mat betaE[`i',1]=fobj[1,4]
		  mat betaY[`i',1]=fobj[1,5]
		  mat betaC[`i',1]=fobj[1,6]
...
local yyy betaK betaL betaE betaY betaC
foreach v of local yyy {
cap drop `v'
svmat `v', names(`v')
}
