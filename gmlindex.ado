*! version 1.0.1  
capture program drop gmlindex
program define gmlindex, rclass
    version 12.1
...
foreach j in GMLindex  Tbetween BETA{
cap drop `j'
}
...
sort `dmu' `time'
cap drop GMLindex
bys `dmu' (`time'): gen GMLindex=(1+BETA[_n-1])/(1+BETA)
