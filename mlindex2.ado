*! version 1.0.1  
capture program drop mlindex2
program define mlindex2, rclass
    version 12.1
...
foreach j in MLindex EFFCH TECCH Tbetween BETA{
cap drop `j'
}
	...
	*local j=1
	...
	forvalues i=1/`T' {
	  ...
	  * mat list Xmat
		   ...
		   *mat list dmutemp2
		   mat dmutemp2[1,1]=-dmutemp2[1,1..`ngo']
...
qui {
	...
	*list d111 in 1/10
	...
	svmat d21 
	svmat d12
	cap drop MLindex EFFCH TECCH 
	*gen MCPI=sqrt(d11*d21/d12/d22)
	*replace MCPI=d21/d22 if missing(MCPI)
	
	cap drop EFFCH TECCH MLindex
	gen EFFCH=d111/d221
	gen TECCH=sqrt(d211/d111*d221/d121)
	replace TECCH=d211/d111 if missing(TECCH)
	gen MLindex=EFFCH*TECCH
